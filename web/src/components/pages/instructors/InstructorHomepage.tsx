...
import InstructorQuestionsHome from './InstructorQuestionsHome';
import InstructorAccountSettings from './InstructorAccountSettings';
    ...
    <Layout style={{ padding: '24px 0' }}>
      ...
      <Content style={{ padding: '0 24px', minHeight: 280 }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          {page === 'questions' ? <InstructorQuestionsHome /> : null}
          {page === 'classes' ? <InstructorClasses /> : null}
          {page === 'account' ? <InstructorAccountSettings /> : null}
        </div>
      </Content>
    </Layout>
  );
